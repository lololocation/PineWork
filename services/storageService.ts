...
export const loadAppData = (): AppData => {
    ...
    const defaultBonusStats = { date: new Date().toISOString().split('T')[0], amount: 0 };
    ...
    try {
        ...
        // 3. 如果还是空的，返回默认值
        if (!jsonString) {
            return { settings: DEFAULT_SETTINGS, tasks: [], focusStats: defaultFocusStats, bonusStats: defaultBonusStats };
        }
        ...
        return {
            ...
            bonusStats: parsed.bonusStats || defaultBonusStats // 确保 bonusStats 存在
        };
